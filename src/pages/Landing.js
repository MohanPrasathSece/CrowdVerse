...
const Landing = () => {
  return (
    <div className="min-h-screen bg-primary-black">
      {/* Hero Section */}
      <section className="pt-44 pb-24 sm:pt-44 sm:pb-28 md:pt-56">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            <h1 className="text-4xl sm:text-5xl md:text-7xl font-light text-off-white tracking-tight leading-tight">
              CrowdVerse<br />
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3 pt-6">
              <Link
                to="/signup"
                className="w-full sm:w-auto px-8 py-3 sm:py-4 bg-off-white text-primary-black font-medium rounded-lg hover:bg-white transition-colors"
              >
                Start Trading
              </Link>
              <Link
                to="/login"
                className="w-full sm:w-auto px-8 py-3 sm:py-4 border border-dark-gray/50 text-off-white rounded-lg hover:border-dark-gray transition-colors"
              >
                Sign In
              </Link>
            </div>
